...
public:
    ...
    /**
     * @brief Adds a user to the gateway.
    ...
    /**
     * @brief Removes a user from the gateway.
    ...
    /**
     * @brief Checks if a user exists in the gateway.
     ...
     */
    std::string getUserTags(std::string username);
